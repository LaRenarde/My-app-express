...
global.actions_json = JSON.parse(
  fs.readFileSync("./routes/config_actions.json", "utf8")
);
...
var database_schemas = JSON.parse(
  fs.readFileSync("database_schemas.json", "utf8")
...
// Permet de comparer 2 chaines de caractère et de faire un trie dans l'affichage des données;
